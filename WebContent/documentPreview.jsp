                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-8">
                                    <button type="button" class="btn btn-block btn-primary btn-circle btn-icon-left" id="scarica">
                                        <a href="AddToCart?codice=<%=material.getCodiceMateriale() %>" style="color:white">Aggiungi al carello <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-plus-fill" viewBox="0 0 16 16">
