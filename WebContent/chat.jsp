                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-3 col-3">
                            <div class="users-container">
                                <div class="chat-search-box">
                                    <a href="<%=creaChatURL %>" class="stretched-link" style="color:#9697e7">Crea Nuova Chat <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-square-dotted" viewBox="0 0 16 16">
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-9 col-9">
                            ...
                            <div class="chat-container">
                                ...
                                <div class="form-group mt-3 mb-0">
                                    ...
                                    <br>
                                    <button class="btn btn-light" type="submit" style="background-color : #9697e7; color:white;">Invia il messaggio</button>
