<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="java.sql.Date,it.unisa.model.*,java.util.Collection,java.util.Iterator"%>
...
<meta name="description"
	content="Manage your Uber Driving Partner account.">
...
<link rel="stylesheet" type="text/css"
	href="https://d1a3f4spazzrp4.cloudfront.net/web-p2/stylesheets/home/icons.e225ddcb0b486de3046f4d4c231185ca.css">
<link
	href="//d1a3f4spazzrp4.cloudfront.net/uber-icons/3.3.0/uber-icons.css"
	rel="stylesheet">
<style>
.btn-principale {
...
<body>
 ...
 %>
	...
	<div class="flexbox height--full main-wrapper">
		...
		<form action="ChangeProfile" method="POST"
			enctype="multipart/form-data" id="main-profile">
		...
		%>
				<div class="alert alert-success alert-dismissible fade show"
					role="alert">
					<strong>Fatto!</strong> Le modifiche sono state salvate con
					successo:<%=success%>
 ...
 -->
							...
							<div class="grid hidden-form hidden">
								...
								<input type="hidden" name="_csrf_token" id="-csrf-token"
									value="1440526831-01-FIiAtX3_sdMNiFb34GXRG49qaUBWsxonFotdT79C_3s=">
								...
								<div class="grid__item one-quarter">
									...
									<img src="PrintProfileImage" class="profile-picture">
										...
										<div class="helper-profile-picture">
											<p>
												<i class="icon icon_picture"></i> <br /> Aggiungi foto
											</p>
										</div>
									</div>
								...
								<div class="grid__item one-third">
									...
									<ul class="form-fields">
										<li><label>Email</label> <input type="text"
											class="text-input" name="mail" onblur="validateEmail(this)">
											<div class="invalid-feedback" id="email-feedback"
												style="font-size: 12px;"></div></li>
									</ul>
									<div class="submit">
										<div class="messages"></div>
										<button
											class="btn btn-principale cancel-hidden-form text-dark">Chiudi</button>
									</div>
								</div>
 ...
 -->
							...
							<div class="grid hidden-form hidden">
								<div class="grid__item one-quarter">Università</div>
								<!--
 -->
								<div class="grid__item one-third">
                      	...
                      	%>
									<label>Universit&agrave;</label> <select class="form-control"
										name="nomeuni">
                        ...
                        <option value="">Scegli...</option>
                  		...
                  		%>
							...
							%>
									</select> <span class="divider"></span> <label>Corso di studi</label> <select
										class="form-control" name="dipartimento">
										<option value="">Scegli...</option>
                 ...
                 <!--  <input type="text" class="text-input" name="nomeuni" placeholder="Nome">
                  ...
                  <input type="text" class="text-input" name="dipartimento" placeholder="Facoltà">
					-->
						...
						<div class="row-group editable-single-row">
							<div class="grid data-row">
								<div class="grid__item one-quarter title">Password</div>
								<!--
 -->
								<div class="grid__item one-half data" data-field="None">
									&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;</div>
 ...
 -->
							...
							<div class="grid hidden-form hidden">
								...
								<div class="grid__item one-third">
									...
									<input type="hidden" name="_csrf_token" id="_csrf_token1"
										value="1440526831-01-FIiAtX3_sdMNiFb34GXRG49qaUBWsxonFotdT79C_3s=">

									<div class="input-group">
										<input type="password" class="text-input"
											name="current_password" placeholder="Password corrente"></input>
										<input type="password" class="text-input" name="password"
											id="pwd" placeholder="Nuova Password"
											onblur="passwordValidation(this,5,12)"></input>
										<div class="valid-feedback">Password valida.</div>
										<div class="invalid-feedback">Per favore inserisci una
											password di lunghezza compresa tra 5 e 12 caratteri, che
											contenga almeno una lettera maiuscola, un numero e una
											lettera minuscola.</div>

										<input type="password" class="text-input"
											name="confirm_password" id="newpwd" onblur="passwordUguali()"
											placeholder="Conferma nuova Password"></input>
										<!--  <div class="valid-feedback">Password valida.</div>
                	<div class="invalid-feedback">Le password non corrispondono.</div> -->
						...
						<div class="row-group editable-single-row">
							<div class="grid data-row">
								<div class="grid__item one-quarter title">Metodo di
									pagamento</div>
								<div class="grid__item one-half data" data-field="None">
									...
									<p class='data' data-field='number'>Ultime 5 cifre della
										carta</p>
							...
							<div class="grid hidden-form hidden">
								<div class="grid__item one-quarter">Metodo di pagamento</div>
								<div class="grid__item one-third">

									<div class="form-group">
										<label class="col-sm-3 control-label">Titolare Carta</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" name="nomecarta"
												placeholder="Nome titolare"></input>
											<p class="help-block">Nome che appare sulla carta</p>
										</div>
										<div class="col-sm-9">
											<input type="text" class="form-control" name="cognomecarta"
												placeholder="Cognome titolare"></input>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											...
											</select> <span class="divider">/</span> <select class="form-control"
												name="year">
											...
											<p class="help-block">La data in cui scade la carta. La
												trovi sul fronte della carta</p>
										</div>
										<label class="col-sm-3 control-label">CVC</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" style="width: 120px;"
												placeholder="CVC">
											<p class="help-block">Le 3 cifre che trovi sul retro
												della carta.</p>
										</div>
									</div>
									<hr>
						...
						<div class="grid__item one-half">
							<div class="submit">
								<div class="messages"></div>
								<button class="btn btn--primary btn-principale text-dark"
									type="submit">Salva le modifiche</button>
	...
	<script type='text/javascript'
		src="https://d1a3f4spazzrp4.cloudfront.net/web-p2/scripts/vendor.7c88512201ad36e1f9d9ff0e6d2077c8.js"></script>
	...
	<script
		src="https://d1a3f4spazzrp4.cloudfront.net/web-p2/scripts/analytics.cb25f45deae12fe2582214808908f898.js"></script>


	<script
		src="https://d1a3f4spazzrp4.cloudfront.net/web-p2/scripts/config.12a9959a1bdf7bcf0055e0f61fe3285a.js"></script>
	<script
		src="https://d1a3f4spazzrp4.cloudfront.net/web-p2/scripts/core.fc0a8ee755f365192f254904593a84f5.js"
		defer></script>
	...
	<script
		src="https://d1a3f4spazzrp4.cloudfront.net/web-p2/scripts/home.5c8d8c29a8be9f0ab47ff38f71bbcd21.js"></script>

 
	<script
		src="https://d1a3f4spazzrp4.cloudfront.net/web-p2/scripts/profile/profile.08c09f44a289bf166e5d65b952b1ee74.js"></script>
