...
not support the canvas tag.</canvas>
					...
					<div class="card-footer">
						<a href="<%=addCartUrl%>?codice=<%=mat.getCodiceMateriale() %>&url=visitUser.jsp" style="color:#9697e7">Aggiungi al carello <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-plus-fill" viewBox="0 0 16 16">
